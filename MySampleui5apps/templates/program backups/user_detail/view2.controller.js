sap.ui.controller("user_detail.view2", {
	...
	getList : function() {
		...
		var id = userid.getText();

		var uniqid = new sap.m.Text();
		uniqid = sap.ui.getCore().byId("uniqid");
		var uid = uniqid.setText();

		var addressid = new sap.m.Text();
		addressid = sap.ui.getCore().byId("addressid");
		var aid = addressid.getText();

		var contactid = new sap.m.Text();
		contactid = sap.ui.getCore().byId("contactid");
		var conid = contactid.getText();
		...
		oTable = sap.ui.getCore().byId("table1");
